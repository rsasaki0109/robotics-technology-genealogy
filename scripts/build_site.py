...
<div id="loading">
  ...
  <div style="color:#888;font-size:13px">Loading the genealogy of 880+ methods&hellip;</div>
</div>

<div id="stories">
  <div class="story-card featured wm" onclick="jumpToStory('World Models for Robotics & Embodied AI','LeWorldModel')">
    <div class="story-icon">🌐</div>
    <div class="story-text"><b>JEPA → V-JEPA 2 → LeWorldModel</b><br>Latent predictors from I-JEPA to 2026 world models<br><span class="story-badge">JEPA</span></div>
  </div>
  <div class="story-card featured vla" onclick="jumpToStory('Imitation Learning & Robot Foundation Models','Qwen-VLA')">
    <div class="story-icon">🦾</div>
    <div class="story-text"><b>RT-2 → OpenVLA / GR00T → Qwen-VLA</b><br>Generalist robot policies across embodiments<br><span class="story-badge">VLA</span></div>
  </div>
...
<div class="header">
  ...
  <div class="controls">
    ...
    <input type="text" id="search" placeholder="Try: Qwen-VLA, GR00T N1.7, VGGT-Omega..." title="Shortcut: press / to search" autocomplete="off" list="search-list">
